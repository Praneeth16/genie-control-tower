          ...
          <CardContent className="space-y-2 p-4">
            ...
            {blinded ? (
              ...
              <div className="space-y-1">
                ...
                <div className="grid grid-cols-2 gap-x-3 text-[11px] tabular-nums text-muted-foreground">
                  {Object.entries(
      ...
      {scope && (
        <Card className="border-border">
          <CardContent className="space-y-3 p-4">
            ...
            <p className="text-[11px] leading-relaxed text-muted-foreground">{scope.note}</p>
            <div className="space-y-1">
              {scope.tables.map((t) => (
                <div key={t.table} className="flex items-center gap-2">
                  <span className="w-44 shrink-0 text-[11px] text-muted-foreground">{t.table}</span>
      ...
      {usage && (
        <Card className="border-border">
          <CardContent className="space-y-3 p-4">
            ...
            <p className="text-[11px] leading-relaxed text-muted-foreground">{usage.note}</p>
          </CardContent>
        </Card>
      )}
